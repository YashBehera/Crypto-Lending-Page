  ...
  return (
    ...
    >
      ...
      <div className="container d-flex flex-column align-items-center justify-content-center home-content">
        ...
        >
          <h1 className="text-center text-primary mb-4">Welcome to Crypto Lending</h1>
          <p className="text-center text-muted mb-4">
            Securely lend and borrow cryptocurrencies in a decentralized environment.
            Get started by connecting your wallet and unlocking new financial possibilities.
          </p>
          ...
          {account && (
            ...
            >
              <p className="text-success text-center mb-3">Connected: {account}</p>
          ...
          <div className="d-flex justify-content-center mt-4">
            ...
            <button className="btn btn-outline-primary" onClick={() => alert('Referral link: ' + window.location.href)}>
              Generate Referral Link
            </button>
          </div>

          <p className="text-center mt-4 text-muted">Ethereum Price: ${ethPrice}</p>
      ...
      <footer className="bg-light text-center py-3 mt-auto shadow-sm">
        <p className="mb-0 text-muted">&copy; 2024 Crypto Lending. All rights reserved.</p>
      </footer>
    </motion.div>
  );
};
